...
* [Message Service](message-service/README.md)
  ...
  * [RabbitMQ](message-service/rabbitmq/README.md)
    ...
    * [Exchange](message-service/rabbitmq/exchange/README.md)
      * [Exchange-Direct](message-service/rabbitmq/exchange/exchange-direct.md)
      * [Exchange-Fanout](message-service/rabbitmq/exchange/exchange-fanout.md)
      * [Exchange-Topic](message-service/rabbitmq/exchange/exchange-topic.md)
      * [Exchange-Header](message-service/rabbitmq/exchange/exchange-header.md)
      * [Exchange-Exchange](message-service/rabbitmq/exchange/exchange-exchange.md)
  ...
  * [Kafka](message-service/kafka/README.md)
    ...
    * [Construction](message-service/kafka/construction/README.md)
      * [Kafka-Producer](message-service/kafka/construction/kafka-producer.md)
      * [Kafka-Consumer](message-service/kafka/construction/kafka-consumer/README.md)
        * [Parallel Consumer](message-service/kafka/construction/kafka-consumer/parallel-consumer.md)
      * [Kafka-Connect](message-service/kafka/construction/kafka-connect/README.md)
        * [Debezium](message-service/kafka/construction/kafka-connect/debezium.md)
      * [Kafka-Stream](message-service/kafka/construction/kafka-stream/README.md)
        * [Basic Kafka Stram](message-service/kafka/construction/kafka-stream/basic-kafka-stram.md)
        * [Stateful and Stateless](message-service/kafka/construction/kafka-stream/stateful-and-stateless.md)
        * [Windowing](message-service/kafka/construction/kafka-stream/windowing.md)
