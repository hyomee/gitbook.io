...
<figure><img src="../../../.gitbook/assets/image (199).png" alt=""><figcaption><p>디렉티브 문법을 시각화</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (41).png" alt=""><figcaption><p>vue devtools</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (29).png" alt="" width="518"><figcaption><p>초기 웹 페이지 화면</p></figcaption></figure>

전환 버튼을 클릭 하고 텍스트 박스에 B를 입력 하면 변경 되는 것을 확인 할 수 있다.

<figure><img src="../../../.gitbook/assets/image (30).png" alt="" width="515"><figcaption><p>화면에서 조작 후 </p></figcaption></figure>
...
Shadow DOM 기능을 Vue에 적용한 것으로 템플릿을 숨겨 놓았다가 이벤트에 의해서 표시 하고자 할 때 사용 되는 것으로 [네이티브 웹 컴포넌트 `<slot>` 엘리먼트](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot)에서 영감을 받았다고 합니다.
...
\
참고 :  [Using shadow DOM](https://developer.mozilla.org/en-US/docs/Web/API/Web\_components/Using\_shadow\_DOM)
{% endhint %}
